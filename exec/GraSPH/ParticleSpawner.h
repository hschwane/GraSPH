...
public:
    ...
    void addVelocityToPoint(glm::vec3 point, float strength); //!< adds a velocity that attracts all particles to a point
...
private:
    ...
    mpu::gph::ShaderProgram m_pointVelShader; //!< shader for adding velocity
